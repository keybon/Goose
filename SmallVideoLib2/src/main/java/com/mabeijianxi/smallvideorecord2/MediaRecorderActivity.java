...
public class MediaRecorderActivity extends Activity implements
    ...
    private void loadViews() {
        ...
        mTitleNext = (ImageView) findViewById(R.id.video_record_sure);
...
//                        mRecordDelete.setChecked(false);
        ...
        } else if (id == R.id.video_record_sure) {
            // 停止录制
            stopRecord();
            /*finish();
...
//                mRecordDelete.setChecked(false);
    ...
    public void onEncodeComplete() {
        ...
        try {
            ...
            intent = new Intent();
            intent.putExtra("RELEASE_FLAG","2");
            intent.putExtra("REQUEST_VIDEO_PATH", mMediaObject.getOutputTempTranscodingVideoPath());
            setResult(0x00002, intent);
