...
public class WebImageController {
    ...
    public static class WebImageControllerBuilder {
        ...
        public WebImageControllerBuilder(String url) {
            webImageParams = new WebImageController();
        ...
        public WebImageControllerBuilder setFailDrawable(int failId) {
            webImageParams.failDrawable = MainApp.IMApp.getResources().getDrawable(failId);
            return this;
        }
        ...
        public WebImageControllerBuilder setPlaceDrawable(int placeId) {
            webImageParams.placeDrawable = MainApp.IMApp.getResources().getDrawable(placeId);
            return this;
        }
